...
<body class="bg-gray-200">
                ...
                <div class="container mx-auto items-center p-5">
                    <ul class="flex items-center space-x-4 ">
                        ...
                        <li class="relative group">
                            <a href="men.php"
                                class="font-semibold text-black px-3 py-2 hover:bg-black hover:text-white active:bg-blue-500 transition-all duration-150 ease-in-out">Men</a>
                            <ul
                        ...
                        <li class="relative group">
                            <a href="kids.php"
                                class="border-b-2 border-black font-semibold text-black px-3 py-2 hover:bg-black hover:text-white transition-all duration-150 ease-in-out">Kids</a>
                            <ul
                                class="absolute -right-10 hidden bg-white text-black shadow-lg mt-2 w-44 z-10 group-hover:block">
                                <?php
                                    $tampilKategori = "SELECT * FROM kategori ORDER BY id_kategori DESC";
    ...
    <div class="flex">
        ...
        <div class="bg-white text-black w-60 h-screen fixed">
            ...
            <div class="text-2xl ml-10 font-bold mb-10 mt-28">Kids Shoes</div>
            <!-- Menu Sidebar -->
            <ul class="">
                <?php
        $tampilKategori = "SELECT * FROM kategori ORDER BY id_kategori DESC";
            ...
            <div class="cotainer mt-36 ml-72 flex flex-wrap gap-5">
             ...
             if (isset($_GET['kategori_id'])) {
                ...
                $query = "SELECT produk.*, jenis.nama_jenis, kategori.nama_kategori FROM produk
                          ...
                          WHERE jenis.nama_jenis = 'kids' AND kategori.id_kategori = $kategori_id";
            } else {
                $query = "SELECT produk.*, jenis.nama_jenis, kategori.nama_kategori FROM produk
                          INNER JOIN jenis ON produk.id_jenis = jenis.id_jenis
                          INNER JOIN kategori ON produk.id_kategori = kategori.id_kategori
                          WHERE jenis.nama_jenis = 'kids' AND stok_produk > 0 ORDER BY id_produk DESC";
            } 
...
>>>>>>> aa4b3fe6a53bc52a2cc392c69ebd46d2bd9f21ff
            ...
            document.location.href = 'kids.php';
            </script>";
        }
        ?>
        </div>
        ...
        <div>
            ...
            keyword.addEventListener('keyup', function() {
                ...
                xhr.open('GET', 'ajax/kids.php?keyword=' + keyword.value, true);
                xhr.send();
            });
            </script>
</body>
