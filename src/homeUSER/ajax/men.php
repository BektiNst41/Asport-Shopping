...
<<<<<<< HEAD
          WHERE (jenis.nama_jenis = 'men')
          AND (produk.nama_produk LIKE '%$keyword%' OR produk.ukuran_produk LIKE '%$keyword%' OR produk.id_kategori LIKE '%$keyword%' OR kategori.nama_kategori LIKE '%$keyword%')
=======
          WHERE jenis.nama_jenis = 'men' AND (produk.nama_produk LIKE '%$keyword%' OR produk.ukuran_produk LIKE '%$keyword%')
>>>>>>> aa4b3fe6a53bc52a2cc392c69ebd46d2bd9f21ff
