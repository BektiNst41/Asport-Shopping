...
<<<<<<< HEAD
          WHERE jenis.nama_jenis = 'kids' AND (produk.nama_produk LIKE '%$keyword%' OR produk.ukuran_produk LIKE '%$keyword%' OR kategori.nama_kategori LIKE '%$keyword%')
=======
          WHERE jenis.nama_jenis = 'kids' AND (produk.nama_produk LIKE '%$keyword%' OR produk.ukuran_produk LIKE '%$keyword%')
